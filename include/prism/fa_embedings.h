/**
 * @file fa_embeddings.h
 * @brief Font Awesome icon codes for use with ImGui
 * @authors IconFontCppHeaders, Font Awesome
 * 
 * Generated by IconFontCppHeaders.
 * To use these icons, you must include the Font Awesome font in your ImGui context.
 * 
 * @see https://fontawesome.com
 * @see https://github.com/juliettef/IconFontCppHeaders
 * @see https://raw.githubusercontent.com/FortAwesome/Font-Awesome/master/metadata/icons.yml
 * @see https://github.com/FortAwesome/Font-Awesome/blob/master/webfonts/fa-regular-400.ttf
 * @see https://github.com/FortAwesome/Font-Awesome/blob/master/webfonts/fa-solid-900.ttf
*/
